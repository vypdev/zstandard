...
/// Windows implementation of [ZstandardPlatform] using the native zstd library.
...
@Deprecated('Use ZstandardWindows.compress with Dart-owned bytes instead.')
...
/// Compatibility wrapper that completes after the pointer call returns.
@Deprecated('Use ZstandardWindows.decompress with Dart-owned bytes instead.')
