...
| zstandard_ios | FFI | SwiftPM target consumes the shared C product; CocoaPods uses an ignored generated compatibility copy |
| zstandard_macos | FFI | SwiftPM target consumes the shared C product; CocoaPods uses an ignored generated compatibility copy |
