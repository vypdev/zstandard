...
2. **Update dependencies** in `pubspec.yaml` to the new version (e.g. `zstandard: ^1.5.0`).
...
- Prefer **caret** constraints for compatibility with patch updates: `zstandard: ^1.5.0`.
- If you must pin exact versions, use `zstandard: 1.5.0`. Prefer caret for easier upgrades.
