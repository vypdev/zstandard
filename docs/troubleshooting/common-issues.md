...
**What to do**:
- Use a consistent version in your `pubspec.yaml` (e.g. `zstandard: ^1.5.0`). Run `flutter pub get` and check for resolution errors.
- If you depend on multiple packages from this repo, align their versions (e.g. all ^1.5.0). See [Migration guide](../guides/migration-guide.md).
